...
TheBotzmann equation for gas flows describes the evolution of the gas molecular velocity distribution function <img src="https://latex.codecogs.com/svg.latex?f = f(t,\boldsymbol{x},\boldsymbol{v})" />: 
